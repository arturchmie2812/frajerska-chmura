...
$CONFIG = '{"lang":"pl","error_reporting":false,"show_hidden":false,"hide_Cols":false,"calc_folder":false}';
...
//Application Title
define('APP_TITLE', 'Menedżer plików');
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a  class="text-muted" data-version="<?php echo VERSION; ?>">Artur Chmielewski</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
